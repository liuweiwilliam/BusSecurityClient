...
public class LzzRButton extends JButton {  
    private static final long serialVersionUID = 39082560987930759L;  
    public static final Color BUTTON_COLOR1 = LzzColorFontMgr.smUIHeadBkColor;  
    public static final Color BUTTON_COLOR2 = LzzColorFontMgr.smUIHeadBkColor;  
    public static final Color BUTTON_FOREGROUND_COLOR = Color.WHITE;
    private boolean hover;  
  
    public LzzRButton(String name) {  
        this.setText(name);  
