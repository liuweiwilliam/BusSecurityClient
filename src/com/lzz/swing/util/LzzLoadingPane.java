...
public class LzzLoadingPane extends JComponent implements MouseListener {  
    /** 
     *  
     */  
    ...
    public LzzLoadingPane() {  
        this("");  
    }  

    public LzzLoadingPane(String text) {  
        this(text, 14);  
    }  

    public LzzLoadingPane(String text, int barsCount) {  
        this(text, barsCount, 0.70f);  
    }  

    public LzzLoadingPane(String text, int barsCount, float shield) {  
        this(text, barsCount, shield, 15.0f);  
    }  

    public LzzLoadingPane(String text, int barsCount, float shield, float fps) {  
        this(text, barsCount, shield, fps, 300);  
    }  

    public LzzLoadingPane(String text, int barsCount, float shield, float fps, int rampDelay) {  
        this.text = text;  
    ...
    protected class Animator implements Runnable {  
        ...
        public void run() {  
            ...
            if (!rampUp) {  
                ...
                setVisible(false);  
                removeMouseListener(LzzLoadingPane.this);  
            }  
        }  
    }  
    ...
    public static void main(String[] args){
        ...
        // ...
        LzzLoadingPane glasspane = new LzzLoadingPane();
