...
public class LzzImgLabelDropMenu extends JPanel{
	/**
	 * 
	 */
	 ...
	 * 子菜单组
	 */
	private LzzImgLabelMenuGroup subMenuGroup = null;
	...
	public LzzImgLabelDropMenu(
		...
		imageLabel.setBounds(0, 0, 100, 50);
		add(imageLabel);
		...
		subMenuGroup = new LzzImgLabelMenuGroup(is_horizontal);
		subMenuGroup.setVisible(false);
		subMenuGroup.addMouseListener(new MouseAdapter(){
			/**
	...
	public LzzImgLabelMenuGroup getSubMenuGroup() {
		return subMenuGroup;
	}

	public void setSubMenuGroup(LzzImgLabelMenuGroup subMenuGroup) {
		this.subMenuGroup = subMenuGroup;
		add(subMenuGroup);
	}

	public void addSubMenu(String name, LzzImgLabelMenu menu, JPanel panel){
		subMenuGroup.addMenu(name, menu, panel);
	}
	...
	public void showSubMenus(){
		subMenuGroup.setLocation(this.getLocation());
		subMenuGroup.setVisible(true);
	}
