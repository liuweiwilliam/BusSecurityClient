...
import com.lzz.swing.component.LzzSubFrame;
...
import com.lzz.swing.util.LzzLoadingPane;
...
public class LzzIndexFrm extends JFrame {
	...
	//遮罩层
	private LzzLoadingPane glasspane;
	...
	private void createNorthPanel() {
		...
		LzzImgLabel alarm_icon = new LzzImgLabel(img_url_alarm, 40, 40);
		northPanel.add(alarm_icon);
		...
		//添加最大化最小化关闭按钮
		LzzFunctionMenus func_menu = new LzzFunctionMenus();
	...
	private void createCenterPanelMap() {
		...
		//地图组件
		webBrowserPanel = new BrowserPanel(LzzProperties.getServerUrl() + "?sessionId=" + LzzUserMgr.userSessionId);
